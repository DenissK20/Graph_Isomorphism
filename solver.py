...
file = "SampleGraphsFastColorRefinement/threepaths160.gr" # substitute with a path to an instance here, file should be in the project folder and then navigated as usual
